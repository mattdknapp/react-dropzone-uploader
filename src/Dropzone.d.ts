...
export declare type StatusValue =
  ...
  | 'headers_received'
  | 'done'
export declare type MethodValue =
  | 'delete'
  | 'get'
  | 'head'
  | 'options'
...
declare class Dropzone extends React.Component<
  IDropzoneProps,
  {
    active: boolean
...
> {
  ...
  forceUpdate: () => void
  getFilesFromEvent: () =>
    | ((event: React.DragEvent<HTMLElement> | React.ChangeEvent<HTMLInputElement>) => (File | DataTransferItem)[])
    | ((event: React.DragEvent<HTMLElement> | React.ChangeEvent<HTMLInputElement>) => File[] | Promise<File[]>)
  getDataTransferItemsFromEvent: () =>
    | ((event: React.DragEvent<HTMLElement> | React.ChangeEvent<HTMLInputElement>) => (File | DataTransferItem)[])
    | ((event: React.DragEvent<HTMLElement>) => DataTransferItem[] | Promise<DataTransferItem[]>)
