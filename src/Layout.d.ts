...
declare const Layout: {
  ...
  propTypes: {
    ...
    previews: PropTypes.Requireable<
      (string | number | boolean | {} | PropTypes.ReactElementLike | PropTypes.ReactNodeArray | null)[]
    >
    submitButton: PropTypes.Requireable<PropTypes.ReactNodeLike>
    dropzoneProps: PropTypes.Validator<
